...
export default function ErrorPage({ message }: { message: string }) {
  return (
    <div className="w-full h-full flex flex-col justify-center items-center bg-blue-50">
      <div className="p-4 rounded-md flex flex-col justify-center items-center bg-white shadow-md border border-slate-200 gap-3">
        <div className="flex items-center gap-2 w-full border-b pb-3">
          ...
          <p className="text-gray-900 font-semibold text-xl">{message}</p>
        </div>
