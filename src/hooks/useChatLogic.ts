  ...
  // 👉 Aquí metemos el mensaje de vuelos + los mensajes reales
  const messagesWithDemo: ChatContent[] = [
    demoFlightMessage,        // primero la card de vuelos
    ...chatState.messages,    // luego todo lo que venga del backend
  ];
